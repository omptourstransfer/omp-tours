...
export const metadata: Metadata = {
  ...
  title: {
    default: 'OMP Tours & Transfer | Best Punta Cana Excursions 2025',
    template: '%s | OMP Tours & Transfer',
  },
  description:
    'Book the best Punta Cana excursions with OMP Tours & Transfer. Saona Island tours, buggy adventures, ATV, whale watching, scuba diving & 31 more. Only 15% deposit online. Hotel pickup included. 5-star rated by 10,000+ guests.',
  keywords: [
  ...
  openGraph: {
    title: 'OMP Tours & Transfer | Best Punta Cana Excursions 2025',
    ...
    url: SITE_URL,
    siteName: 'OMP Tours & Transfer',
    locale: 'en_US',
    images: [{ url: OG_IMAGE, width: 1440, height: 900, alt: 'OMP Tours & Transfer – Punta Cana Excursions' }],
    type: 'website',
  },
  twitter: {
